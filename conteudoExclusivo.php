     ...
     <body>
          <div id="conteudo">
               <?php
                    if ($_SESSION['login']){
               ?>
                         <h1 style="color:white"><span class="destaca"><?php echo $_SESSION['nome_usuario']; ?></span>, seja bem-vindo ao Conteúdo Exclusivo</h1>
                         <div class="borda"></div>
                         <div class="logout">
